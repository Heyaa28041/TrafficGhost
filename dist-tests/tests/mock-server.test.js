...
(0, node_test_1.describe)('Mock Server End-to-End Dynamic Behavior', () => {
    ...
    (0, node_test_1.it)('should authenticate the demo login request with the captured contract', async () => {
    ...
    (0, node_test_1.it)('should return 400 for missing login fields', async () => {
    ...
    (0, node_test_1.it)('should return 401 for invalid login credentials', async () => {
        const res = await makeRequest(TEST_PORT, 'POST', '/api/login', {
    ...
    (0, node_test_1.it)('should return the captured 429 login response in rate-limited mode', async () => {
    ...
    (0, node_test_1.it)('should return the captured 500 login response in server-error mode', async () => {
    ...
    (0, node_test_1.it)('should preserve login responses in Ghost Mode', async () => {
